CREATE SCHEMA IF NOT EXISTS POSTGRES.CELERIX;

CREATE TABLE POSTGRES.CELERIX.empleados (
...
INSERT INTO POSTGRES.CELERIX.empleados VALUES
...
CREATE TABLE POSTGRES.CELERIX.departamentos (
    id_departamento INT PRIMARY KEY,
    nombre_departamento VARCHAR(50)
);

INSERT INTO POSTGRES.CELERIX.departamentos VALUES
(1, 'Ventas'),
(2, 'Marketing'),
(3, 'Recursos Humanos'),
(4, 'Tecnología');
...
CREATE TABLE POSTGRES.CELERIX.productos (
...
INSERT INTO POSTGRES.CELERIX.productos VALUES
(1, 'Laptop', 1200.00, 50),
...
CREATE TABLE POSTGRES.CELERIX.clientes (
...
INSERT INTO POSTGRES.CELERIX.clientes VALUES
...
CREATE TABLE POSTGRES.CELERIX.pedidos (
...
INSERT INTO POSTGRES.CELERIX.pedidos VALUES
...
CREATE TABLE POSTGRES.CELERIX.detalle_pedidos (
...
INSERT INTO POSTGRES.CELERIX.detalle_pedidos (id_detalle, id_pedido, id_producto, cantidad, precio_unitario) VALUES
